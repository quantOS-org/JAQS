...
# autodoc settings
autoclass_content = 'both' # both class docstring and __init__ docstring
...
exclude_patterns = ['build', 'Thumbs.db', '.DS_Store', 'store', 'theme']
...
if not on_rtd:  # only import and set the theme if we're building docs locally
    try:
        ...
        themedir = os.path.join(os.pardir, 'theme')
